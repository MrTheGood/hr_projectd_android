...
import nl.hr.projectrage.OnboardingPageAdapter.ViewHolder

class OnboardingPageAdapter : RecyclerView.Adapter<ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_onboarding, parent, false) as ViewGroup)
        ...
        when (position) {
            0 -> holder.view.apply {
                ...
                bodyText.text =
                    ...
                    """.trimIndent()
                imageView.setImageResource(R.drawable.bg_onboarding)
